    ...
    execute: function () {
      ...
      _export('NegociacaoService', NegociacaoService = function () {
        ...
        _createClass(NegociacaoService, [{
          ...
          value: function obterNegociacaoDaSemanaAnterior(cb) {
            var _this = this;
          ...
          value: function obterNegociacaoDaSemanaRetrasada(cb) {
            var _this2 = this;
          ...
          value: function obterNegociacaoDaSemana() {
            ...
            return new Promise(function (resolve, reject) {
              _this3._http.get('negociacoes/semana').then(function (negociacoes) {
                resolve(negociacoes.map(function (objeto) {
                  return new Negociacao(new Date(objeto.data), objeto.quantidade, objeto.valor);
                }));
              }).catch(function (erro) {
          ...
          value: function obterNegociacoes() {
            return Promise.all([this.obterNegociacaoDaSemana(), this.obterNegociacaoDaSemanaAnterior(), this.obterNegociacaoDaSemanaRetrasada()]).then(function (periodos) {
